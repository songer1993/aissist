# Environment-Aware Plugin Integration

## Overview
Enables automatic detection of development vs production environments to use appropriate marketplace URLs when installing the aissist Claude Code plugin.
