# Capability: DateTime Context Hook

Provides automatic injection of current date and time into Claude Code session context via a `UserPromptSubmit` hook in the aissist plugin.
