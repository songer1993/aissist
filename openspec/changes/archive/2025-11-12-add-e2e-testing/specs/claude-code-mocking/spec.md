...
## Purpose
Provides a mock Claude Code CLI executable for testing aissist commands that depend on Claude integration without requiring actual Claude Code installation or authentication.
