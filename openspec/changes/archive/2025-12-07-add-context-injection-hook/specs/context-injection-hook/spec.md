# Capability: Context Injection Hook

Provides automatic injection of active goals and recent history into Claude Code session context via a `SessionStart` hook, controlled by a configuration flag.
