...
## Purpose
Provides beautiful terminal rendering for Markdown output, making CLI responses more readable and professional while maintaining machine-readable raw output option.
